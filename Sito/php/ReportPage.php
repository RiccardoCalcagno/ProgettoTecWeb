...
{
    str_replace("<input id=\"Accesso\" type=\"submit\" name=\"accesso\" value=\"Accedi\">", "<input id=\"Accesso\" type=\"submit\" name=\"accesso\" value=\"Esci\">", $html);
    str_replace("<input id=\"Iscrizione\" type=\"submit\" name=\"accesso\" value=\"Iscrizione\">", "<input id=\"Iscrizione\" type=\"submit\" name=\"accesso\" value=\"Area Personale\">", $html);
}
