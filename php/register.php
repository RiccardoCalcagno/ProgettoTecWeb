...
//        echo "utente vuoto";
        ...
        if($err["empty_passwd"])
        {
       $html = str_replace("<p id=\"PasswordEmpty\" class=\"hidden\">","<p id=\"PasswordEmpty\" class=\"text-errore\" tabindex='10' role=\"alert\">", $html);
...
//        echo "password vuota";
    ...
    {
            $html = str_replace("<p class=\"RepPasswdErr hidden\">","<p class=\"RepPasswdErr text-errore\" tabindex='10' role=\"alert\">", $html);
