...
function preparePage($htmlPage, $toEdit) {
    ...
    if ( $toEdit ){
        ...
        $header = '<header id="intestazionePagina">
            <h1>Modifica Scheda Giocatore<span> <a class="puntoInterrogativo" data-approf="Cos è Scheda Giocatore" href="../php/Approf_personaggio.php">?</a></span></h1>
            </header>';
        ...
        $header = '<header id="intestazionePagina">
            <h1>Creazione Scheda Giocatore<span> <a class="puntoInterrogativo" data-approf="Cos è Scheda Giocatore" href="../php/Approf_personaggio.php">?</a></span></h1>
